...
export const validateCityName = param("city")
  ...
  .isString()
  // We will use the isIn method to check if the city param is either london or dublin or tokyo
  .isIn(["london", "dublin", "tokyo"])
  // We will use the withMessage method to set a custom error message
  .withMessage("City name must be either london dublin, or tokyo");
